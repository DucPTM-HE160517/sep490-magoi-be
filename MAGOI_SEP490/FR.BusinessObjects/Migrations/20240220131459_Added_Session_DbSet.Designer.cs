...
namespace FR.BusinessObjects.Migrations
{
    ...
    [Migration("20240220131459_Added_Session_DbSet")]
    partial class Added_Session_DbSet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FR.BusinessObjects.Models.Table", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d573d186-c0f2-44ae-8731-206678518f50"),
                            Name = "Bàn 1",
                            StatusId = 2
                        },
                        new
                        {
                            Id = new Guid("e68e913d-29de-4264-92a7-4cf4230eb925"),
                            Name = "Bàn 2",
                            StatusId = 2
                        },
                        new
                        {
                            Id = new Guid("0df79f6f-8261-406e-abce-f74b79851750"),
                            Name = "Bàn 3",
                            StatusId = 2
                        },
                        new
                        {
                            Id = new Guid("b451465f-6983-4103-a931-bf9baf6194d4"),
                            Name = "Bàn 4",
                            StatusId = 2
                        },
                        new
                        {
                            Id = new Guid("8c611345-7eb4-4fa1-b067-af5bcffec647"),
                            Name = "Bàn 5",
                            StatusId = 2
                        },
                        new
                        {
                            Id = new Guid("4c26dd96-dcc3-48db-9ad2-813d98331013"),
                            Name = "Bàn 6",
                            StatusId = 1
                        },
                        new
                        {
                            Id = new Guid("b35194f1-3795-49a2-b68b-4c674c31cd16"),
                            Name = "Bàn 7",
                            StatusId = 1
                        },
                        new
                        {
                            Id = new Guid("21c95749-9a82-402b-865b-35c595d5bb18"),
                            Name = "Bàn 8",
                            StatusId = 1
                        },
                        new
                        {
                            Id = new Guid("910cd7f3-394d-41d2-a084-fc7f2d5e8a7e"),
                            Name = "Bàn 9",
                            StatusId = 1
                        },
                        new
                        {
                            Id = new Guid("1eaa0dcb-c1eb-4dc1-abdd-82393fce875e"),
                            Name = "Bàn 10",
                            StatusId = 3
                        },
                        new
                        {
                            Id = new Guid("f2338aad-59cf-4a3e-a583-8b9e147d36c5"),
                            Name = "Bàn 11",
                            StatusId = 3
                        },
                        new
                        {
                            Id = new Guid("d25603d9-9ce9-4f16-8152-c37ac3ce5aa3"),
                            Name = "Bàn 12",
                            StatusId = 3
                        });
                });
